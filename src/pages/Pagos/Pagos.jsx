    ...
    <main className="p-6 min-h-screen bg-background-dark dark:bg-background-dark text-gray-200 dark:text-gray-200">
      ...
      <section className="mb-6 bg-gray-800 dark:bg-gray-800 p-6 rounded-lg border">
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label className="block text-sm text-gray-100">Alumno</label>
          ...
          <div>
            <label className="block text-sm text-gray-100">Fecha de pago</label>
          ...
          <div>
            <label className="block text-sm text-gray-100">Monto ($)</label>
          ...
          <div>
            <label className="block text-sm text-gray-100">Meses pagados (selecciona 1 o más)</label>
